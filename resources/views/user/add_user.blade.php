                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form class="form-horizontal form-label-left input_mask" data-parsley-validate id="loginForm" action="{{route('user.store') }}" method="POST">
                               ...
                               <div class="item form-group">
                                    ...
                                    <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" data-validate-words="1" name="name" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                                    </div>
                               </div>
                               <div class="item form-group">
